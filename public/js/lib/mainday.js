    ...
    */
    ...
    function renderInnerContent$6(innerProps) {
        return (createElement("div", { className: "fc-event-main-frame" },
            innerProps.timeText &&
            (createElement("div", { className: "fc-event-wwid" }, innerProps.event.extendedProps.WWID)),
            (createElement("div", { className: "fc-event-category-wwid" }, innerProps.event.extendedProps.WWID)),
            (createElement("div", { className: "fc-event-category" }, innerProps.event.extendedProps.category)),
            (createElement("div", { className: "fc-event-category-time" }, innerProps.event.extendedProps.fromto)), ));
    }
    ...
    */
    ...
    var TimeCol = /** @class */ (function(_super) {
        ...
        TimeCol.prototype.renderPositionedFgSegs = function(segs, // if not mirror, needs to be sorted
            ...
            var _c = computeFgSegPlacements$1(segs, segVCoords, eventOrderStrict, eventMaxStack),
    ...
    var TimelineHeaderThInner = /** @class */ (function(_super) {
        ...
        TimelineHeaderThInner.prototype.render = function() {
            var _a = this,
                props = _a.props,
                context = _a.context;
            var navLinkAttrs = props.navLinkData ? { 'data-navlink': props.navLinkData, tabIndex: 0 } : {};
        ...
        TimelineLaneMoreLink.prototype.render = function() {
            ...
            return (createElement(MoreLinkRoot, {
                ...
                return (createElement("a", {
                        ...
                        style: __assign({ visibility: isVisible ? '' : 'hidden', top: top || 0 }, hStyle),
                        onClick: handleClick
                    },
                    ...
                    return (createElement("th", { ref: rootElRef, className: ['fc-datagrid-cell'].concat(classNames).join(' ') },
                        createElement("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                            createElement("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
                                ...
                                createElement("span", { className: "fc-datagrid-cell-main", ref: innerElRef }, innerContent)), !isLastCol &&
